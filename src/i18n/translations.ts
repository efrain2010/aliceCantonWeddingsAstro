  ...
  es: {
    ...
    pages: {
      ...
      gallery: {
        ...
        photos: [
          { src: '/images/48194719-1055283917984535-516330673288511488-o-1024x660.jpg', alt: 'Invitados fotografiando a la novia', span: 'md:col-span-2 md:row-span-2' },
          { src: '/images/hg1a5445-1024x683.jpg', alt: 'Ceremonia', span: '' },
          { src: '/images/wedding-bouquet-pakbnhh-220x300.jpg', alt: 'Decoración', span: '' },
          { src: '/images/48397507-1055284681317792-3700600962478505984-o-1024x648.jpg', alt: 'Novios', span: '' },
          { src: '/images/48059233-1055284081317852-5632184094931550208-o-1-1024x597.jpg', alt: 'Hacienda', span: '' },
          { src: '/images/dsc00641-1024x674.jpg', alt: 'Detalles', span: 'md:col-span-2' },
          { src: '/images/48244230-1056587157856808-6144760103514931200-o-1024x682.jpg', alt: 'Recepción', span: '' },
          { src: '/images/11866446-1055970124415858-485634197070961453-n.jpg', alt: 'Flores', span: '' },
          { src: '/images/img-20181028-115340-999-623x1024.jpg', alt: 'Primer baile', span: '' },
        ],
      },
      contact: {
        meta: {
  ...
  en: {
    ...
    pages: {
      ...
      gallery: {
        ...
        photos: [
          { src: '/images/48194719-1055283917984535-516330673288511488-o-1024x660.jpg', alt: 'Guests photographing the bride', span: 'md:col-span-2 md:row-span-2' },
          { src: '/images/hg1a5445-1024x683.jpg', alt: 'Ceremony', span: '' },
          { src: '/images/wedding-bouquet-pakbnhh-220x300.jpg', alt: 'Decoration', span: '' },
          { src: '/images/48397507-1055284681317792-3700600962478505984-o-1024x648.jpg', alt: 'Couple', span: '' },
          { src: '/images/48059233-1055284081317852-5632184094931550208-o-1-1024x597.jpg', alt: 'Hacienda', span: '' },
          { src: '/images/dsc00641-1024x674.jpg', alt: 'Details', span: 'md:col-span-2' },
          { src: '/images/48244230-1056587157856808-6144760103514931200-o-1024x682.jpg', alt: 'Reception', span: '' },
          { src: '/images/11866446-1055970124415858-485634197070961453-n.jpg', alt: 'Flowers', span: '' },
          { src: '/images/img-20181028-115340-999-623x1024.jpg', alt: 'First dance', span: '' },
        ],
      },
      contact: {
        meta: {
