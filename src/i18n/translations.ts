    ...
    pages: {
      home: {
        ...
        services: {
          ...
          items: [
            { icon: '♛', title: 'Coordinación Total', description: 'Cubrimos todos los aspectos creativos, organizacionales, técnicos y logísticos de tu boda. Ideal para parejas que desean dejar todo en nuestras manos y disfrutar cada momento sin estrés.' },
            { icon: '✈', title: 'Coordinación Boda Destino', description: 'Especializada en bodas en Yucatán para parejas que vienen de otras ciudades o países. Incluye sugerencias de hospedaje, logística de invitados y coordinación completa del evento.' },
            { icon: '◈', title: 'Coordinación del Día', description: 'Para parejas que ya tienen todo planeado y solo necesitan a alguien de confianza el día de la boda. Nos encargamos de la logística, montaje y tiempos para que tú solo disfrutes.' },
          ],
        },
        history: {
          label: 'Desde 2014',
          title: 'Nuestra Historia',
          body1: 'Alice Cantón es una apasionada de la organización de eventos con enfoque en la planeación de bodas. Su filosofía es simple:',
          quote: '"Cada boda que planifico, lo hago con todo el amor, entusiasmo y dedicación como si fuera la mía propia."',
          body2: 'Con más de una década de experiencia en Mérida, Yucatán, Alice y su equipo han creado experiencias únicas en haciendas históricas, playas paradisíacas, cenotes sagrados y las aguas turquesas de Bacalar.',
        ...
        testimonials: {
          ...
          items: [
            { quote: 'Alice fue increíble. Desde la primera consulta hasta el último baile, todo estuvo perfecto. Su profesionalismo y dedicación hicieron que nuestro día fuera exactamente como lo soñamos.', author: 'Jessi Rodriguez', year: '2015' },
            { quote: 'No podría haber elegido mejor wedding planner. Alice conoce cada detalle, cada proveedor, cada locación. Nuestra boda en hacienda fue un sueño hecho realidad gracias a ella.', author: 'Yare Leal', year: '2016' },
            { quote: 'Contratar a Alice fue la mejor decisión que tomamos para nuestra boda. Su equipo estuvo presente en cada momento y nos permitió disfrutar sin preocupaciones. ¡Eternamente agradecidos!', author: 'Martha & Sergio', year: '2017' },
          ],
        },
      },
      about: {
    ...
    pages: {
      home: {
        ...
        services: {
          ...
          title: 'Our Services',
          items: [
            { icon: '♛', title: 'Full Coordination', description: 'We cover all creative, organizational, technical, and logistical aspects of your wedding. Perfect for couples who want to leave everything in our hands and enjoy every moment stress-free.' },
            { icon: '✈', title: 'Destination Wedding Coordination', description: 'Specialized in Yucatán weddings for couples coming from other cities or countries. Includes accommodation suggestions, guest logistics, and complete event coordination.' },
            { icon: '◈', title: 'Day-of Coordination', description: 'For couples who have everything planned and just need a trusted person on their wedding day. We handle the logistics, setup, and timeline so you can simply enjoy your day.' },
          ],
        },
        history: {
          label: 'Since 2014',
          title: 'Our Story',
          body1: 'Alice Cantón is passionate about event organization with a focus on wedding planning. Her philosophy is simple:',
          quote: '"Every wedding I plan, I do with all the love, enthusiasm, and dedication as if it were my own."',
          body2: 'With over a decade of experience in Mérida, Yucatán, Alice and her team have created unique experiences at historic haciendas, paradise beaches, sacred cenotes, and the turquoise waters of Bacalar.',
        ...
        testimonials: {
          ...
          items: [
            { quote: 'Alice was incredible. From the first consultation to the last dance, everything was perfect. Her professionalism and dedication made our day exactly as we dreamed it.', author: 'Jessi Rodriguez', year: '2015' },
            { quote: "I couldn't have chosen a better wedding planner. Alice knows every detail, every vendor, every venue. Our hacienda wedding was a dream come true thanks to her.", author: 'Yare Leal', year: '2016' },
            { quote: 'Hiring Alice was the best decision we made for our wedding. Her team was present at every moment and allowed us to enjoy without worry. Eternally grateful!', author: 'Martha & Sergio', year: '2017' },
          ],
        },
      },
      about: {
